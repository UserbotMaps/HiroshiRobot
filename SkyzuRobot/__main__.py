...
*Hello {} !*
────────────────────────
✨ sᴀʏᴀ ᴀᴅᴀʟᴀʜ ʙᴏᴛ ᴛᴜʀʙᴏ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇʀ  ᴄʜᴀᴛ ɢʀᴏᴜᴘ ᴀɴᴅᴀ ᴅᴀɴ ᴊᴀᴅɪᴋᴀɴ sᴀʏᴀ ᴀᴅᴍɪɴ ᴅᴀɴ ʙᴇʀɪ ɪᴢɪɴ ᴍᴀɴᴀɢᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ✨
✨ Maintained by @Bisubiarenak ✨
────────────────────────
✨ ᴋʟɪᴋ ᴛᴏᴍʙᴏʟ /help ᴜɴᴛᴜᴋ ᴍᴇɴɢᴇᴛᴀʜᴜɪ ғɪᴛᴜʀ ᴍᴇɴᴀʀɪᴋ ᴅᴀʀɪ ʙᴏᴛ ʜɪʀᴏsʜɪ..
"""
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ​", url="https://github.com/UserbotMaps/HiroshiRobot"
        ),
        InlineKeyboardButton(
    ...
    [
        InlineKeyboardButton(
            text="➗ ᴀᴅᴅ sᴋʏᴢᴜ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ​ ➗", url="t.me/Hiroshirobot?startgroup=new"),
    ],
]
...
EMI_IMG = "https://telegra.ph/file/babd23aaf0a1e1672283c.jpg"
    ...
    if query.data == "Skyzu_":
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ​", url="t.me/hiroshisupport"),
                    InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇs​", url="https://t.me/bombleebas"),
                 ],
                 [
                    InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Skyzu_"),
        ...
        query.message.edit_text(
            ...
            f"\nHere Developers Making The HiroshiRobot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
